...
export class ProjectService {
  ...
  initialiseProjects() {
    ...
    boLui.description =
      'Bo Lui is a quirky Telegram Bot that tracks your ' +
    ...
    website.description =
      'I have always wanted a website with my own domain. ' +
    ...
    chiaCollection.description =
      'Designed and sold more than 150 articles of clothing worldwide.\n\n' +
    ...
    chiaCollection.image =
      '../../assets/images/project-image-the-chia-collection.jpg';
    ...
    (fintechSocietyNFT.oneLiner = 'NUS Fintech Society NFT Website'),
      (fintechSocietyNFT.description =
        'I joined NUS Fintech Society in August and finally, ' +
    ...
    fintechSocietyNFT.githubLink =
      'https://github.com/brendancjz/nus-fintech-society-nft';
    ...
    tompang.description =
      'Travelers can offer to buy back overseas products for interested ' +
      ...
      'both leveraging on Glassfish. \n\nThis project is completed within a semester under the module IS3106: Enterprise Systems Interface Design and Development.';
    tompang.techUsed = [
      'CSS',
      'Glassfish',
      'HTML',
    ...
    bestbudsbot.date = 'Jun 2022';
    bestbudsbot.oneLiner = 'Birthday Tracking Bot for Telegram Groups';
    bestbudsbot.description =
      'It is a hassle to discreetly collate birthday messages for a friend in a group. ' +
    ...
    splitEase.date = 'Apr 2023';
    splitEase.oneLiner =
      "SplitEase helps to split the gathering's bill with ease";
    splitEase.description =
      'During my semester-long Student Exchange Program in the UK, my friends and I had trouble ' +
    ...
    const virtualNursing = new Project();
    virtualNursing.name = 'Virtual Nursing Dashboard';
    virtualNursing.date = 'Nov 2023';
    virtualNursing.oneLiner =
      'Data-Driven Care, Anywhere: Bridging Nurses, Enhancing Lives';
    virtualNursing.description =
      "The hospital's smart wards, equipped with cutting-edge technology like smart beds and " +
      'wearable patches, face a challenge in efficiently managing patient care due to a shortage of healthcare ' +
      'professionals. Nurses grapple with vast amounts of clinical data from IoT sensors, necessitating a smart ward ' +
      'analytics system. This system aims to consolidate and present patient data for efficient monitoring, ' +
      'triggering alerts for nurses in cases of abnormalities or deterioration.\n\n' +
      'Creating a prototype clinical dashboard and mobile app—Virtual Nursing Web Application & Virtual Nursing ' +
      'Mobile Application (VNM)—to centralize patient data from smart beds and wearables. These tools enable virtual ' +
      'nurses to monitor multiple patients remotely, customize data views, and alert ground nurses for timely patient ' +
      'care, streamlining care processes and ensuring patient safety. \n\n' +
      'This project is completed within a semester under the module IS4103: Information Systems Capstone Project.';
    virtualNursing.techUsed = [
      'AWS',
      'Expo',
      'Firebase',
      'JavaScript',
